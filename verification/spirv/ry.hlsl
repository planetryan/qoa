...
void comp_main()
{
    do
    {
        ...
        if (gl_GlobalInvocationID.x < _41)
        {
            ...
            float _71 = cos(_70);
            float _76 = sin(_70);
            _53.Store2(gl_GlobalInvocationID.x * 8 + 0, asuint(float2((_71 * _58.x) - (_76 * _62.x), (_71 * _58.y) - (_76 * _62.y))));
            _53.Store2(_41 * 8 + 0, asuint(float2((_71 * _62.x) + (_76 * _58.x), (_71 * _62.y) + (_76 * _58.y))));
        }
        break;
    } while(false);
}
